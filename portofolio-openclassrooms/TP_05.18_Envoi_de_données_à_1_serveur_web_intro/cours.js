...
ajaxPost("http://localhost/post_form.php", commande,
    function (reponse) {
...
form.addEventListener("submit", function (e) {
    ...
    ajaxPost("http://localhost/post_form.php", data, function () {});
});
...
ajaxPost("http://localhost/post_json.php", film,
    function (reponse) {
...
req.open("POST", "http://localhost/post_form.php");
