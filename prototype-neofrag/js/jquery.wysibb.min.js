  ...
  (function (a) {
    ...
    (a.wysibb = function (b, c) {
      a(b).data("wbb", this),
        c &&
          c.deflang &&
          "undefined" != typeof WBBLANG[c.deflang] &&
          (CURLANG = WBBLANG[c.deflang]),
        c &&
          c.lang &&
          "undefined" != typeof WBBLANG[c.lang] &&
          (CURLANG = WBBLANG[c.lang]),
        (this.txtArea = b),
        (this.$txtArea = a(b));
      ...
      (this.options = {
        ...
        smileConversion: !0,
        buttons:
          "bold,italic,underline,strike,sup,sub,|,img,video,link,|,bullist,numlist,|,fontcolor,fontsize,fontfamily,|,justifyleft,justifycenter,justifyright,|,quote,code,table,removeFormat,star",
        allButtons: {
          bold: {
            title: CURLANG.bold,
          ...
          strike: {
            ...
            buttonHTML:
              '<span class="fonticon fi-stroke1 ve-tlb-strike1"></span>',
            excmd: "strikeThrough",
            transform: {
          ...
          star: {
            title: "note1",
            buttonHTML: '<span class="fonticon ve-tlb-star1">★</span>',
            hotkey: "ctrl+n",
            transform: {
              "<b><size=150>★</size>{SELTEXT}</b>":
                "[b][size=150]★[/size]{SELTEXT}[/b]",
              "<strong>★{SELTEXT}</strong>": "[b]★{SELTEXT}[/b]",
            },
          },
          ...
          offtop: {
            ...
            buttonText: "offtop",
            transform: {
              '<span style="font-size:10px;color:#ccc">{SELTEXT}</span>':
                "[offtop]{SELTEXT}[/offtop]",
            },
          },
          fontcolor: {
            type: "colorpicker",
            ...
            subInsert: !0,
            colors:
              "#000000,#444444,#666666,#999999,#b6b6b6,#cccccc,#d8d8d8,#efefef,#f4f4f4,#ffffff,-, 							 #ff0000,#980000,#ff7700,#ffff00,#00ff00,#00ffff,#1e84cc,#0000ff,#9900ff,#ff00ff,-, 							 #f4cccc,#dbb0a7,#fce5cd,#fff2cc,#d9ead3,#d0e0e3,#c9daf8,#cfe2f3,#d9d2e9,#ead1dc, 							 #ea9999,#dd7e6b,#f9cb9c,#ffe599,#b6d7a8,#a2c4c9,#a4c2f4,#9fc5e8,#b4a7d6,#d5a6bd, 							 #e06666,#cc4125,#f6b26b,#ffd966,#93c47d,#76a5af,#6d9eeb,#6fa8dc,#8e7cc3,#c27ba0, 							 #cc0000,#a61c00,#e69138,#f1c232,#6aa84f,#45818e,#3c78d8,#3d85c6,#674ea7,#a64d79, 							 #900000,#85200C,#B45F06,#BF9000,#38761D,#134F5C,#1155Cc,#0B5394,#351C75,#741B47, 							 #660000,#5B0F00,#783F04,#7F6000,#274E13,#0C343D,#1C4587,#073763,#20124D,#4C1130",
            transform: {
              '<font color="{COLOR}">{SELTEXT}</font>':
                "[color={COLOR}]{SELTEXT}[/color]",
            },
          },
          table: {
            type: "table",
            ...
            transform: {
              ...
              '<table class="wbb-table">{SELTEXT}</table>':
                "[table]{SELTEXT}[/table]",
            },
            skipRules: !0,
          },
          ...
          fontfamily: {
            ...
            transform: {
              '<font face="{FONT}">{SELTEXT}</font>':
                "[font={FONT}]{SELTEXT}[/font]",
            },
          },
          smilebox: {
            type: "smilebox",
          ...
          justifyleft: {
            ...
            groupkey: "align",
            transform: {
              '<p style="text-align:left">{SELTEXT}</p>':
                "[left]{SELTEXT}[/left]",
            },
          },
          justifyright: {
            ...
            groupkey: "align",
            transform: {
              '<p style="text-align:right">{SELTEXT}</p>':
                "[right]{SELTEXT}[/right]",
            },
          },
          justifycenter: {
            ...
            groupkey: "align",
            transform: {
              '<p style="text-align:center">{SELTEXT}</p>':
          ...
          video: {
            ...
            modal: {
              ...
              onSubmit: function (a) {
                ...
                if (
                  ((c = b.match(
                    -1 != b.indexOf("youtu.be")
                      ? /^http[s]*:\/\/youtu\.be\/([a-z0-9_-]+)/i
                      : /^http[s]*:\/\/www\.youtube\.com\/watch\?.*?v=([a-z0-9_-]+)/i
                  )),
                  c && 2 == c.length)
                ) {
                  var d = c[1];
            ...
            transform: {
              '<iframe src="http://www.youtube.com/embed/{SRC}" width="640" height="480" frameborder="0"></iframe>':
                "[video]{SRC}[/video]",
            },
          },
          fs_verysmall: {
        ...
        customRules: {
          td: [
            ["[td]{SELTEXT}[/td]", { seltext: { rgx: !1, attr: !1, sel: !1 } }],
          ],
          tr: [
            ["[tr]{SELTEXT}[/tr]", { seltext: { rgx: !1, attr: !1, sel: !1 } }],
          ],
          table: [
            [
              "[table]{SELTEXT}[/table]",
              { seltext: { rgx: !1, attr: !1, sel: !1 } },
            ],
          ],
        },
        smileList: [],
        ...
        this.options.themePrefix ||
          a("link").each(
            a.proxy(function (b, c) {
              ...
              null !== d &&
                ((this.options.themeName = d[2]),
                (this.options.themePrefix = d[1]));
            }, this)
          ),
        "undefined" != typeof WBBPRESET &&
          (WBBPRESET.allButtons &&
            a.each(
              WBBPRESET.allButtons,
              a.proxy(function (a, b) {
                b.transform &&
                  this.options.allButtons[a] &&
                  delete this.options.allButtons[a].transform;
              }, this)
            ),
          a.extend(!0, this.options, WBBPRESET)),
        c &&
          c.allButtons &&
          a.each(
            c.allButtons,
      ...
      (a.wysibb.prototype = {
        ...
        init: function () {
          a.log("Init", this),
            ...
            this.options.smileList &&
              this.options.smileList.length > 0 &&
              this.options.smileList.sort(function (a, b) {
                return b.bbcode.length - a.bbcode.length;
              }),
            this.$txtArea.parents("form").bind(
              "submit",
              a.proxy(function () {
                return this.sync(), !0;
              }, this)
        ...
        initTransforms: function () {
            ...
            if (e) {
              if (
                ...
                e.simplebbcode &&
                  ...
                  2 == e.simplebbcode.length &&
                  ((e.bbcode = e.html =
                    e.simplebbcode[0] + "{SELTEXT}" + e.simplebbcode[1]),
                  e.transform && delete e.transform,
                  e.modal && delete e.modal),
                "select" == e.type && "string" == typeof e.options)
              ) {
              ...
              if (e.transform && e.skipRules !== !0) {
                ...
                for (var h in g) {
                  var i = h,
                    j = g[h];
                  if (
                    (e.bbSelector || (e.bbSelector = []),
                    -1 == a.inArray(j, e.bbSelector) && e.bbSelector.push(j),
                    this.options.onlyBBmode === !1)
                  ) {
                    h = this.wrapAttrs(h);
                    var k = a(document.createElement("DIV")).append(
                        a(this.elFromString(h, document))
                      ),
                      l = this.filterByNode(k.children());
                    if ("div" == l || "undefined" != typeof b.rules[l]) {
                      a.log("create unique selector: " + l),
                        this.setUID(k.children()),
                        (l = this.filterByNode(k.children())),
                        a.log("New rootSelector: " + l);
                      var m = k.html();
                      m = this.unwrapAttrs(m);
                      var n = this.unwrapAttrs(h);
                      (e.transform[m] = j),
                        delete e.transform[n],
                        (h = m),
                        (i = m);
                    }
                    e.excmd ||
                      (e.rootSelector || (e.rootSelector = []),
                      e.rootSelector.push(l)),
                      "undefined" == typeof b.rules[l] && (b.rules[l] = []);
                    var o = {};
                    if (h.match(/\{\S+?\}/)) {
                      k.find("*").each(
                        a.proxy(function (b, c) {
                                ...
                                a.proxy(function (b, d) {
                                  ...
                                  if (g)
                                    for (var h = 0; h < g.length; h++) {
                                      ...
                                      i = i.replace(
                                        this.getValidationRGX(i),
                                        ""
                                      );
                                      var j = this.relFilterByNode(c, l),
                                        k =
                                          f != g[h]
                                            ? this.getRegexpReplace(f, g[h])
                                            : !1,
                                        m = j ? a.trim(j) : !1;
                                      if (
                                        a.inArray(m, e) > -1 ||
                                        a(d).parent().contents().length > 1
                                      ) {
                                        var n = a("<span>").html("{" + i + "}");
                                        this.setUID(n, "wbb");
                    ...
                    b.rules[l].push([j, o]),
                      e.onlyClearText === !0 &&
                        ...
                        (this.cleartext[l] = c[d])),
                      e.groupkey &&
                        (b.groups[e.groupkey] || (b.groups[e.groupkey] = []),
                        b.groups[e.groupkey].push(l));
                  }
                }
                e.rootSelector && this.sortArray(e.rootSelector, -1);
                var q = a
                  .map(e.transform, function (a, b) {
                    return b;
                  })
                  .sort(function (a, b) {
          ...
          (this.options.btnlist = c),
            a.extend(b.rules, this.options.customRules),
            (b.srules = {}),
            this.options.smileList &&
              a.each(
                b.smileList,
          ...
          for (var r in b.rules)
            this.options.rules[r].sort(function (a, b) {
              return b[0].length - a[0].length;
            });
          this.rsellist = [];
        ...
        build: function () {
          if (
            (a.log("Build editor"),
            (this.$editor = a("<div>").addClass("wysibb")),
            this.isMobile && this.$editor.addClass("wysibb-mobile"),
            ...
            if (
              ((this.$body = a(
                this.strf(
                  ...
                  { maxheight: c, height: b }
                )
              ).insertAfter(this.$txtArea)),
              (this.body = this.$body[0]),
              this.$txtArea.hide(),
              b > 32 && this.$toolbar.css("max-height", b),
              a.log("WysiBB loaded"),
              this.$body
                .addClass("wysibb-body")
            ...
            this.txtArea.value.length > 0 && this.txtAreaInitContent(),
              this.$body.bind(
                ...
                a.proxy(function (b) {
                  return (86 == b.which &&
                    (1 == b.ctrlKey || 1 == b.metaKey)) ||
                    (45 == b.which && (1 == b.shiftKey || 1 == b.metaKey))
                    ? (this.$pasteBlock ||
                        (this.saveRange(),
                        (this.$pasteBlock = a(
                          this.elFromString(
                            '<div style="opacity:0;" contenteditable="true">﻿</div>'
                          )
                        )),
                        ...
                        setTimeout(
                          a.proxy(function () {
                            ...
                            var b =
                              "<span>" + this.$pasteBlock.html() + "</span>";
                            this.$body.attr("contentEditable", "true"),
                              this.$pasteBlock.blur().remove(),
                              this.body.focus(),
                              this.cleartext &&
                                (a.log("Check if paste to clearText Block"),
                ...
                a.proxy(function (a) {
                  if (13 == a.which) {
                    ...
                    b ||
                      ...
                      this.insertAtCursor("<br/>", !1));
                  }
                }, this)
              ),
              this.options.tabInsert === !0 &&
                this.$body.bind("keydown", a.proxy(this.pressTab, this)),
              this.$body.bind("mouseup keyup", a.proxy(this.updateUI, this)),
              this.$body.bind(
                "mousedown",
                a.proxy(function (a) {
              ...
              this.options.traceTextarea === !0 &&
                (a(document).bind(
                  "mousedown",
                  a.proxy(this.traceTextareaEvent, this)
                ),
                this.$txtArea.val("")),
              this.options.hotkeys === !0 &&
                this.$body.bind("keydown", a.proxy(this.presskey, this)),
              this.options.smileConversion === !0 &&
                this.$body.bind("keyup", a.proxy(this.smileConversion, this)),
              (this.inited = !0),
              this.options.autoresize === !0 &&
                (this.$bresize = a(
                  this.elFromString('<div class="bottom-resize-line"></div>')
                )
                  .appendTo(this.$editor)
                  .wdrag({ scope: this, axisY: !0, height: b })),
              this.imgListeners();
          }
          this.$txtArea.bind(
            "mouseup keyup",
            a.proxy(function () {
              clearTimeout(this.uitimer),
                (this.uitimer = setTimeout(a.proxy(this.updateUI, this), 100));
            }, this)
          ),
            this.options.hotkeys === !0 &&
              a(document).bind("keydown", a.proxy(this.presskey, this));
        },
        buildToolbar: function () {
          ...
          a.each(
            ...
            a.proxy(function (c, d) {
              ...
              (0 == c || "|" == d || "-" == d) &&
                ("-" == d && this.$toolbar.append("<div>"),
                (b = a('<div class="wysibb-toolbar-container">').appendTo(
                  this.$toolbar
                ))),
                e &&
                  ("colorpicker" == e.type
                    ? this.buildColorpicker(b, d, e)
                    : "table" == e.type
                    ? this.buildTablepicker(b, d, e)
                    : "select" == e.type
                    ? this.buildSelect(b, d, e)
                    : "smilebox" == e.type
                    ? this.buildSmilebox(b, d, e)
                    : this.buildButton(b, d, e));
            }, this)
          ),
          ...
          1 == this.options.bbmode &&
            c.children(".wysibb-toolbar-btn").addClass("on"),
            this.options.onlyBBmode === !1 &&
              c.children(".wysibb-toolbar-btn").click(
                a.proxy(function (b) {
        ...
        buildButton: function (b, c, d) {
          ...
          var e = d.buttonHTML
              ? a(this.strf(d.buttonHTML, this.options)).addClass("btn-inner")
              : this.strf('<span class="btn-inner btn-text">{text}</span>', {
                  text: d.buttonText.replace(/</g, "&lt;"),
                }),
            f =
              this.options.hotkeys === !0 &&
              this.options.showHotkeys === !0 &&
              d.hotkey
                ? ' <span class="tthotkey">[' + d.hotkey + "]</span>"
                : "",
            g = a('<div class="wysibb-toolbar-btn wbb-' + c + '">')
              .appendTo(b)
              .append(e)
              .append(
                this.strf(
                  '<span class="btn-tooltip">{title}<ins/>{hotkey}</span>',
                  { title: d.title, hotkey: f }
                )
              );
          this.controllers.push(g),
            g.bind(
              "queryState",
              a.proxy(function (b) {
                this.queryState(c)
                  ? a(b.currentTarget).addClass("on")
                  : a(b.currentTarget).removeClass("on");
              }, this)
            ),
            g.mousedown(
              a.proxy(function (b) {
                b.preventDefault(),
                  this.execCommand(c, d.exvalue || !1),
                  a(b.currentTarget).trigger("queryState");
              }, this)
            );
        },
        buildColorpicker: function (b, c, d) {
          var e = a('<div class="wysibb-toolbar-btn wbb-dropdown wbb-cp">')
              .appendTo(b)
              .append(
                '<div class="ve-tlb-colorpick"><span class="fonticon"></span><span class="cp-line"></span></div><ins class="fonticon ar"></ins>'
              )
              .append(
                this.strf('<span class="btn-tooltip">{title}<ins/></span>', {
                  title: d.title,
                })
              ),
            f = e.find(".cp-line"),
          ...
          for (
            var h = d.colors ? d.colors.split(",") : [], i = 0;
            i < h.length;
            i++
          )
            (h[i] = a.trim(h[i])),
              g.append(
                "-" == h[i]
                  ? '<span class="pl"></span>'
                  : this.strf(
                      '<div class="sc" style="background:{color}" title="{color}"></div>',
                      { color: h[i] }
                    )
              );
          ...
          this.controllers.push(e),
            e.bind(
              ...
              a.proxy(function () {
                ...
                a &&
                  (f.css("background-color", this.options.bbmode ? a.color : a),
                  e
                    .find(".ve-tlb-colorpick span.fonticon")
                    .css("color", this.options.bbmode ? a.color : a));
              }, this)
            ),
            e.mousedown(
              a.proxy(function (a) {
                a.preventDefault(),
                  this.dropdownclick(".wbb-cp", ".wbb-list", a);
              }, this)
            ),
            e.find(".sc").mousedown(
              a.proxy(function (b) {
        ...
        buildTablepicker: function (b, c, d) {
          var e = a('<div class="wysibb-toolbar-btn wbb-dropdown wbb-tbl">')
              .appendTo(b)
              .append(
          ...
          e.find(".tbl-sel").mousedown(
            a.proxy(function (b) {
              b.preventDefault();
              for (
                var c = a(b.currentTarget).attr("title"),
                  d = c.split(","),
                  e = this.options.bbmode
                    ? "[table]"
                ...
                for (var g = 1; g <= d[1]; g++)
                  e += this.options.bbmode ? "  [td][/td]\n" : "<td>﻿</td>";
                e += this.options.bbmode ? "[/tr]\n" : "</tr>";
              }
              (e += this.options.bbmode ? "[/table]" : "</table>"),
            ...
            e.mousedown(
              a.proxy(function (a) {
                a.preventDefault(),
                  this.dropdownclick(".wbb-tbl", ".wbb-list", a);
              }, this)
            );
        },
        buildSelect: function (b, c, d) {
          for (
            var e = a(
                '<div class="wysibb-toolbar-btn wbb-select wbb-' + c + '">'
              )
                .appendTo(b)
                .append(
                  this.strf(
                    '<span class="val">{title}</span><ins class="fonticon sar"></ins>',
                    d
                  )
                )
                .append(
              ...
              f = a('<div class="wbb-list">').appendTo(e),
              g = e.find("span.val"),
              h = a.isArray(d.options) ? d.options : d.options.split(","),
              i = this.isMobile ? a("<select>").addClass("wbb-selectbox") : "",
              j = 0;
            j < h.length;
            j++
          ) {
            ...
            if ("string" == typeof k) {
              ...
              l &&
                (l.html
                  ? a("<span>")
                      .addClass("option")
                      .attr("oid", k)
                      .attr("cmdvalue", l.exvalue)
                      .appendTo(f)
                      .append(this.strf(l.html, { seltext: l.title }))
                  : f.append(
                      this.strf(
              ...
              (m[d.valueBBname] = k.exvalue),
                a("<span>")
                  .addClass("option")
                  .attr("oid", c)
                  .attr("cmdvalue", k.exvalue)
                  .appendTo(f)
                  .append(this.strf(d.html, m)),
                this.isMobile &&
                  i.append(
                    a("<option>")
                      .attr("oid", c)
          ...
          this.isMobile &&
                ...
                i.find("option").each(
                  a.proxy(function (b, c) {
                    var d = a(c),
                      ...
                      f = d.attr("cmdvalue");
                    return (f && e == d.attr("cmdvalue")) || (!f && e)
                      ? (d.prop("selected", !0), !1)
                      : void 0;
                  }, this)
                );
            ...
            i.change(
              a.proxy(function (b) {
                ...
                this.execCommand(d, f.exvalue || e || !1),
                  a(b.currentTarget).trigger("queryState");
              }, this)
            )),
            this.controllers.push(e),
                  ...
                  e.find(".option").each(
                    a.proxy(function (b, c) {
                      var d = a(c),
                        ...
                        f = d.attr("cmdvalue");
                      return (f && e == d.attr("cmdvalue")) || (!f && e)
                        ? (g.text(d.text()), d.addClass("selected"), !1)
                        : void 0;
                    }, this)
                  );
              }, this)
            ...
            e.mousedown(
              a.proxy(function (a) {
                a.preventDefault(),
                  this.dropdownclick(".wbb-select", ".wbb-list", a);
              }, this)
            ),
            e.find(".option").mousedown(
              a.proxy(function (b) {
                b.preventDefault();
                var c = a(b.currentTarget).attr("oid"),
                  d = a(b.currentTarget).attr("cmdvalue"),
                  e = this.options.allButtons[c];
                this.execCommand(c, e.exvalue || d || !1),
                  a(b.currentTarget).trigger("queryState");
              }, this)
            );
        },
        buildSmilebox: function (b, c, d) {
          if (this.options.smileList && this.options.smileList.length > 0) {
            var e = a(this.strf(d.buttonHTML, d)).addClass("btn-inner"),
              f = a(
                '<div class="wysibb-toolbar-btn wbb-smilebox wbb-' + c + '">'
              )
                .appendTo(b)
                .append(e)
                .append(
            ...
            a.isArray(this.options.smileList) &&
              a.each(
                this.options.smileList,
                a.proxy(function (b, c) {
                  a("<span>")
                    ...
                    .appendTo(g)
                    .append(
                      a(this.strf(c.img, this.options)).attr("title", c.title)
                    );
                }, this)
              ),
              f.mousedown(
                a.proxy(function (a) {
                  a.preventDefault(),
                    this.dropdownclick(".wbb-smilebox", ".wbb-list", a);
                }, this)
              ),
              f.find(".smile").mousedown(
                a.proxy(function (b) {
                  b.preventDefault(),
                    this.insertAtCursor(
                      this.options.bbmode
                        ? this.toBB(a(b.currentTarget).html())
                        : a(a(b.currentTarget).html())
                    );
                }, this)
              );
          }
          ...
          (this.$modal = a("#wbbmodal")),
            0 == this.$modal.length &&
              ...
              (this.$modal = a("<div>")
                ...
                .hide()),
              this.$modal
                .find("#wbbm-cancel,.wbbclose")
                .click(a.proxy(this.closeModal, this)),
              this.$modal.bind(
                "click",
                a.proxy(function (b) {
                  0 == a(b.target).parents(".wbbm").length && this.closeModal();
                }, this)
              ),
              a(document).bind("keydown", a.proxy(this.escModal, this)));
        },
              ...
              if (d.hotkey) {
                ...
                if (e && e.length >= 2) {
                  ...
                  a.each(e, function (b, c) {
                    ...
                    f > 0 &&
                      (this.hotkeys["m" + f] || (this.hotkeys["m" + f] = []),
                      (this.hotkeys["m" + f]["k" + (b.indexOf(g) + 48)] = c));
                }
              }
            }, this)
          );
        ...
        presskey: function (a) {
          if (1 == a.ctrlKey || 1 == a.shiftKey || 1 == a.altKey) {
            var b =
              ...
              (1 == a.shiftKey ? 4 : 0) +
              (1 == a.altKey ? 7 : 0);
            if (this.hotkeys["m" + b] && this.hotkeys["m" + b]["k" + a.which])
              return (
                this.execCommand(this.hotkeys["m" + b]["k" + a.which], !1),
                a.preventDefault(),
                !1
              );
          }
          ...
          if (!f || f == b) {
            if (d.excmd)
              if (this.options.bbmode)
                if (
                  (a.log("Native command in bbmode: " + b),
                  e && 1 != d.subInsert)
                )
                  this.wbbRemoveCallback(b, c);
                else {
                  var g = {};
                  d.valueBBname && c && (g[d.valueBBname] = c),
                    this.insertAtCursor(this.getBBCodeByCommand(b, g));
                }
              else this.execNativeCommand(d.excmd, c || !1);
            else
              d.cmd
                ? d.cmd.call(this, b, c, e)
                : this.wbbExecCommand.call(this, b, c, e);
            this.updateUI();
          }
        },
        queryState: function (b, c) {
          ...
          if (c)
            try {
              var h = (document.queryCommandValue(d.excmd) + "").replace(
                /\'/g,
                ""
              );
            ...
            try {
              return ("bold" != d.excmd &&
                "italic" != d.excmd &&
                "underline" != d.excmd &&
                "strikeThrough" != d.excmd) ||
                !a(this.getSelectNode()).is("img")
                ? "underline" == d.excmd &&
                  a(this.getSelectNode()).closest("a").length > 0
                  ? !1
                  : document.queryCommandState(d.excmd)
                : !1;
            } catch (i) {
              return !1;
            }
        ...
        wbbExecCommand: function (b, c, d) {
          ...
          if (e)
            if (e.modal)
              a.isFunction(e.modal)
                ? e.modal.call(this, b, e.modal, d)
                : this.showModal.call(this, b, e.modal, d);
                  ...
                  a.each(
                    ...
                    a.proxy(function (b, c) {
                      ...
                      if (d) {
                        ...
                        return (
                          a(d).replaceWith(e),
                          this.selectNode(this.$editor.find("#" + f)[0]),
                          !1
                        );
                      }
                    }, this)
        ...
        wbbInsertCallback: function (b, c) {
          ...
          if (
            ...
            this.seltextID && -1 != d.indexOf(this.seltextID))
          ) {
          ...
          if (this.options.bbmode) {
            ...
            a.each(
              ...
              a.proxy(function (b, d) {
                ...
                return g
                  ? ((this.txtArea.value =
                      this.txtArea.value.substr(0, g[1]) +
                      this.txtArea.value
                        .substr(g[1], this.txtArea.value.length - g[1])
                        .replace(g[0][0], c === !0 ? "" : g[0][e + 1])),
                    this.setCursorPosBB(g[1]),
                    !1)
                  : void 0;
              }, this)
            );
            ...
            a.each(
              ...
              a.proxy(function (e, g) {
                ...
                if (window.getSelection) {
                  ...
                  o.setStart(h.firstChild, 0),
                    o.setEndBefore(q),
                    p.setStartAfter(q),
                    p.setEndAfter(h.lastChild);
                ...
                return (
                  c !== !0 && i.after(n),
                  window.getSelection
                    ? (i.html(r), c !== !0 && this.selectNode(n))
                    : i.replaceWith(r),
                  !1
                );
              }, this)
          ...
          if ((this.body.focus(), "insertHTML" != b || window.getSelection))
            if ("insertHTML" == b) {
              ...
              "undefined" == typeof c && (c = !1),
                this.lastRange &&
                  (a.log("Last range select"), this.selectLastRange()),
            ...
            var h = a("<div>").html(c).text(),
              i = h.indexOf("﻿");
            i > -1 &&
              (g.moveStart("character", -1 * (h.length - i)), g.select()),
              (this.lastRange = !1);
          }
        },
        getCodeByCommand: function (a, b) {
          return this.options.bbmode
            ? this.getBBCodeByCommand(a, b)
            : this.getHTMLByCommand(a, b);
        },
        getBBCodeByCommand: function (b, c) {
          if (!this.options.allButtons[b]) return "";
          "undefined" == typeof c && (c = {}),
            (c = this.keysToLower(c)),
            c.seltext || (c.seltext = this.getSelectText(!0));
          ...
          d = d.replace(/\{(.*?)(\[.*?\])*\}/g, function (a, b, d) {
            if (d) {
              ...
              if (
                (d && (e = new RegExp(d + "+", "i")),
                "undefined" != typeof c[b.toLowerCase()] &&
                  null === c[b.toLowerCase()].toString().match(e))
              )
                return "";
            }
            return "undefined" == typeof c[b.toLowerCase()]
              ? ""
              : c[b.toLowerCase()];
          });
          var e = null,
              ...
              a.each(g, function (a, b) {
                ...
                (b = b.replace(/\{(.*?)(\[.*?\])*\}/g, function (a, b, e) {
                  ...
                  return (
                    ...
                    e && (f = new RegExp(e + "+", "i")),
                    ("undefined" == typeof c[b.toLowerCase()] ||
                      (e && null === c[b.toLowerCase()].toString().match(f))) &&
                      (d = !1),
                    "undefined" == typeof c[b] || h[b] || ((h[b] = 1), g++),
                    "undefined" == typeof c[b.toLowerCase()]
                      ? ""
                      : c[b.toLowerCase()]
                  );
        ...
        getHTMLByCommand: function (b, c) {
          ...
          (c = this.keysToLower(c)),
            "undefined" == typeof c && (c = {}),
            c.seltext ||
              ((c.seltext = this.getSelectText(!1)),
              "" == c.seltext
                ? (c.seltext = "﻿")
                : ((c.seltext = this.clearFromSubInsert(c.seltext, b)),
                  this.options.allButtons[b].onlyClearText === !0 &&
                    (c.seltext = this.toBB(c.seltext)
                      .replace(/\</g, "&lt;")
                      .replace(/\n/g, "<br/>")
          ...
          (this.seltextID = "wbbid_" + ++this.lastid),
            "link" != b && "img" != b
              ? (c.seltext =
                  '<span id="' + this.seltextID + '">' + c.seltext + "</span>")
              : (d = '<span id="' + this.seltextID + '">﻿</span>');
                ...
                (b = b.replace(/\{(.*?)(\[.*?\])*\}/g, function (a, b, f) {
                  ...
                  return (
                    ...
                    ("undefined" == typeof c[b] ||
                      (f && null === c[b].toString().match(g))) &&
                      (d = !1),
                    "undefined" == typeof c[b] || h[b] || ((h[b] = 1), e++),
                    "undefined" == typeof c[b] ? "" : c[b]
                  );
                })),
                  d && e > g && ((f = b), (g = e));
              });
        ...
        getSelection: function () {
          return window.getSelection
            ? window.getSelection()
            : document.selection
            ? (this.options.bbmode, document.selection.createRange())
            : void 0;
        },
        getSelectText: function (b, c) {
          ...
          return (
            ...
            window.getSelection
              ? c
                ? a("<div>").append(c.cloneContents()).html()
                : ""
              : c.htmlText
          );
        },
        getRange: function () {
          if (!window.getSelection)
            return this.options.bbmode === !0, document.selection.createRange();
        ...
        insertAtCursor: function (b, c) {
          if (
            ("string" != typeof b && (b = a("<div>").append(b).html()),
            (this.options.bbmode && "undefined" == typeof c) || c === !0)
          ) {
            var d = b.replace(/.*(\[\/\S+?\])$/, "$1"),
              e =
                this.getCursorPosBB() +
                (-1 != b.indexOf(d) && b.match(/\[.*\]/)
                  ? b.indexOf(d)
                  : b.length);
            document.selection
              ? (this.txtArea.focus(), (this.getSelection().text = b))
              : (this.txtArea.selectionStart ||
                  "0" == this.txtArea.selectionStart) &&
                (this.txtArea.value =
                  this.txtArea.value.substring(0, this.txtArea.selectionStart) +
                  b +
                  this.txtArea.value.substring(
                    this.txtArea.selectionEnd,
                    this.txtArea.value.length
                  )),
              0 > e && (e = 0),
              this.setCursorPosBB(e);
          } else {
        ...
        getSelectNode: function (b) {
          if ((this.body.focus(), b || (b = this.getRange()), !b))
            return this.$body;
        ...
        getCursorPosBB: function () {
          ...
          if ("selectionStart" in this.txtArea) a = this.txtArea.selectionStart;
            ...
            c.moveToElementText(this.txtArea),
        ...
        setCursorPosBB: function (a) {
          if (this.options.bbmode)
            if (window.getSelection)
              (this.txtArea.selectionStart = a),
                (this.txtArea.selectionEnd = a);
            else {
        ...
        setBodyFocus: function () {
          a.log("Set focus to WysiBB editor"),
            this.options.bbmode
              ? this.$txtArea.is(":focus") || this.$txtArea.focus()
              : this.$body.is(":focus") || this.$body.focus();
        },
        ...
        filterByNode: function (b) {
          ...
          a.each(
            ...
            a.proxy(function (b, d) {
              var f = c.attr(d);
              if (
                ("_" == d.substr(0, 1) && (d = d.substr(1, d.length)),
                f && !f.match(/\{.*?\}/))
              )
                if ("style" == d) {
                  var f = c.attr(d),
        ...
        relFilterByNode: function (b, c) {
          var d = "";
          for (
            a.each(this.options.attrWrap, function (a, b) {
              c = c.replace("[" + b, "[_" + b);
            });
            b && "BODY" != b.tagName && !a(b).is(c);

          )
            (d = this.filterByNode(b) + " " + d), b && (b = b.parentNode);
          return d;
        },
        ...
        toBB: function (b) {
          ...
          c.find("div,blockquote,p").each(function () {
            3 != this.nodeType &&
              this.lastChild &&
              "BR" == this.lastChild.tagName &&
              a(this.lastChild).remove();
          }),
            c.is("div,blockquote,p") &&
              3 != c[0].nodeType &&
              c[0].lastChild &&
              "BR" == c[0].lastChild.tagName &&
              a(c[0].lastChild).remove(),
            c.find("ul > br, table > br, tr > br").remove();
          var d = "";
          return (
            a.each(
              this.options.srules,
              ...
              a.proxy(function (b, c) {
                ...
                if (3 === c.nodeType)
                  ...
                  for (var f = 0; f < this.rsellist.length; f++) {
                    ...
                    if (e && e.is(g))
                      for (
                        var h = this.options.rules[g], b = 0;
                        b < h.length;
                        b++
                      ) {
                        var i = h[b][0],
                        ...
                        if (
                            ...
                            a.proxy(function (b, d) {
                              ...
                              "undefined" == typeof f &&
                                (a.log(
                                  "Param: {" +
                                    d +
                                    "} not found in HTML representation."
                                ),
                                (k = !0));
                                ...
                                if ("style" == f.attr) {
                                  ...
                                  var p = "",
                                    q = f.rgx
                                      ...
                                      .replace(/\.\*$/, "")
                                      .replace(/;$/, "");
                                  a(g.attr("style").split(";")).each(function (
                                    a,
                                    b
                                  ) {
                                    b &&
                                  ...
                                  f.rgx === !1 &&
                                    ((l = !0), (m = !0), g.removeAttr(f.attr));
                              return (
                                e.is("table,tr,td,font") && (l = !0), h || ""
                              );
                            }, this)
                          )),
                          !k)
                          ...
                          e.is("table,tr,td")
                            ? ((i = this.fixTableTransform(i)),
                              (d += this.toBB(a("<span>").html(i))),
                              (e = null))
                            : e.empty().html("<span>" + i + "</span>");
                        }
                      }
                  }
        ...
        getHTML: function (b, c, d) {
          ...
          d ||
            (b = b
              ...
              .replace(/\{/g, "&#123;")
              .replace(/\}/g, "&#125;")),
            (b = b.replace(/\[code\]([\s\S]*?)\[\/code\]/g, function (a) {
              return (
                (a = a
                  .substr(
                    "[code]".length,
                    a.length - "[code]".length - "[/code]".length
                  )
                  .replace(/\[/g, "&#91;")
                  .replace(/\]/g, "&#93;")),
                "[code]" + a + "[/code]"
            ...
            a.each(
              ...
              a.proxy(function (c, d) {
                if ("|" != d && "-" != d) {
                  if (
                    !this.options.allButtons[d] ||
                    !this.options.allButtons[d].transform
                  )
                    return !0;
                  a.each(
                    this.options.allButtons[d].transform,
            ...
            a.each(this.options.systr, function (a, c) {
              (c = c
                .replace(/(\(|\)|\[|\]|\.|\*|\?|\:|\\|\\)/g, "\\$1")
                .replace(" ", "\\s")),
          ...
          a.each(
            ...
            a.proxy(function (b, e) {
              ...
              if (-1 != f) {
                ...
                return (
                  (c.data = d = c.data.substr(0, f)),
                  a(c).after(h).after(this.strf(e.img, this.options)),
                  this.getHTMLSmiles(c.parentNode),
                  !1
                );
              }
        ...
        strf: function (b, c) {
          return (
            (c = this.keysToLower(a.extend({}, c))),
            b.replace(/\{([\w\.]*)\}/g, function (b, d) {
              d = d.toLowerCase();
              var e = d.split("."),
        ...
        elFromString: function (b) {
          if (-1 != b.indexOf("<") && -1 != b.indexOf(">")) {
            ...
            return (
              a(c).html(b),
              this.setUID(c, "wbb"),
              a(c).contents().length > 1 ? c : c.firstChild
            );
          }
        ...
        isBBContain: function (a) {
          for (
            var b,
              c = this.getCursorPosBB(),
              d = this.prepareRGX(a),
              e = new RegExp(d, "g"),
              f = 0;
            null != (b = e.exec(this.txtArea.value));
        ...
        checkForLastBR: function (b) {
          ...
          var c = a(b);
          if (
            (c.is("span[id*='wbbid']") && (c = c.parent()),
            this.options.bbmode === !1 &&
              c.is("div,blockquote,code") &&
              c.contents().length > 0)
          ) {
            var d = c[0].lastChild;
            (!d || (d && "BR" != d.tagName)) && c.append("<br/>");
          }
          this.$body.contents().length > 0 &&
            "BR" != this.body.lastChild.tagName &&
            this.$body.append("<br/>");
        },
        ...
        clearFromSubInsert: function (b, c) {
          if (
            this.options.allButtons[c] &&
            this.options.allButtons[c].rootSelector
          ) {
            var d = a("<div>").html(b);
            return (
              a.each(
                ...
                a.proxy(function (b, c) {
                  var e = !1;
                  "undefined" != typeof this.options.rules[c][0][1].seltext &&
                    (e = this.options.rules[c][0][1].seltext.sel);
                  var f = !0;
                  return (
                    d.find("*").each(function () {
                      a(this).is(c) &&
                        (a(this).replaceWith(
                          e && e.sel
                            ? a(this).find(e.sel.toLowerCase()).html()
                            : a(this).html()
                        ),
                        (f = !1));
                    }),
        ...
        splitPrevNext: function (b) {
          ...
          a(b.nextSibling).is(c) &&
            (a(b).append(a(b.nextSibling).html()), a(b.nextSibling).remove()),
            a(b.previousSibling).is(c) &&
              (a(b).prepend(a(b.previousSibling).html()),
              a(b.previousSibling).remove());
        },
        modeSwitch: function () {
          this.options.bbmode
            ...
            : (this.$txtArea
                .val(this.getBBCode())
                .css("min-height", this.$body.height()),
              this.$body.hide(),
        ...
        clearEmpty: function () {
          function b() {
            return a(this).is("span,font,a,b,i,u,s")
              ? a(this).hasClass("wbbtab") || 0 != a.trim(a(this).html()).length
                ? a(this).children().length > 0 &&
                  (a(this).children().filter(b).remove(),
                  0 == a(this).html().length && "BODY" != this.tagName)
                  ? !0
                  : void 0
                : !0
              : !1;
        ...
        dropdownclick: function (b, c, d) {
          ...
          e.hasClass("dis") ||
            (e.attr("wbbshow")
              ? (e.removeAttr("wbbshow"),
                a(document).unbind("mousedown", this.dropdownhandler),
                document &&
                  a(document).unbind("mousedown", this.dropdownhandler),
                (this.lastRange = !1))
              : (this.saveRange(),
                this.$editor.find("*[wbbshow]").each(function (b, c) {
                  a(c)
                    .removeClass("on")
                    .find(a(c).attr("wbbshow"))
                    .hide()
                    .end()
                    .removeAttr("wbbshow");
                }),
        ...
        dropdownhandler: function (b, c, d, e) {
          0 == a(e.target).parents(c).length &&
            (b.removeClass("on").find(d).hide(),
            a(document).unbind("mousedown", this.dropdownhandler),
            this.$body && this.$body.unbind("mousedown", this.dropdownhandler));
        },
        rgbToHex: function (a) {
          ...
          return (
            "#" +
            this.dec2hex(parseInt(c[2])) +
            this.dec2hex(parseInt(c[3])) +
            this.dec2hex(parseInt(c[4]))
          );
        },
        dec2hex: function (a) {
        ...
        clearPaste: function (b) {
          ...
          a.each(
            ...
            c.find("*[wbbkeep!='1']").each(
              a.proxy(function (b, c) {
                var d = a(c);
                !d.is("div,p") ||
                  (0 != d.children().length && "BR" == c.lastChild.tagName) ||
                  d.after("<br/>");
              }, this)
            ),
            c.find("*[wbbkeep]").removeAttr("wbbkeep").removeAttr("style"),
            a.log(c.html()),
            c.html(this.getHTML(this.toBB(c), !0)),
            a.log(c.html());
        },
        ...
        pressTab: function (a) {
          a &&
            ...
            this.options.bbmode
              ...
              : this.insertAtCursor('<span class="wbbtab">﻿</span>', !1));
        },
        removeLastBodyBR: function () {
          this.body.lastChild &&
            3 != this.body.lastChild.nodeType &&
            "BR" == this.body.lastChild.tagName &&
            (this.body.removeChild(this.body.lastChild),
            this.removeLastBodyBR());
        },
        traceTextareaEvent: function (b) {
          0 == a(b.target).closest("div.wysibb").length &&
            (a(document.activeElement).is("div.wysibb-body") &&
              this.saveRange(),
            setTimeout(
              a.proxy(function () {
                ...
                this.options.bbmode !== !1 ||
                  ...
                  (this.selectLastRange(),
                  this.insertAtCursor(this.getHTML(c, !0)),
                  this.$txtArea.val("")),
                  a(document.activeElement).is("div.wysibb-body") &&
                    (this.lastRange = !1);
              }, this),
        ...
        smileConversion: function () {
          if (this.options.smileList && this.options.smileList.length > 0) {
            ...
            if (3 == b.nodeType) {
              var c = b.data;
              c.length >= 2 &&
                !this.isInClearTextBlock(b) &&
                0 == a(b).parents("a").length &&
                a.each(
                  this.options.srules,
                  a.proxy(function (d, e) {
                    ...
                    if (-1 != g) {
                      ...
                      return (
                        (b.data = b.data.substr(0, g)),
                        a(b)
                          .after(i)
                          .after(j)
                          .after(this.strf(e[1], this.options)),
                        this.selectNode(j),
                        !1
                      );
                    }
        ...
        wrapAttrs: function (b) {
          return (
            a.each(this.options.attrWrap, function (a, c) {
              b = b.replace(c + '="', "_" + c + '="');
            }),
            b
          );
        ...
        disNonActiveButtons: function () {
          this.isInClearTextBlock()
            ? this.$toolbar
                .find(".wysibb-toolbar-btn:not(.on,.mswitch)")
                .addClass("dis")
        ...
        imgEventHandler: function (b) {
          var c = a(b.target);
          this.hasWrapedImage &&
            (0 == c.closest(".wbb-img,#wbbmodal").length ||
              c.hasClass("wbb-cancel-button")) &&
            (this.$body.find(".imgWrap ").each(function () {
              a.log("Removed imgWrap block"),
                a(this).replaceWith(a(this).find("img"));
            }),
            (this.hasWrapedImage = !1),
            this.updateUI()),
            c.is("img") &&
              c.closest(".wysibb-body").length > 0 &&
              (c.wrap("<span class='imgWrap'></span>"),
              (this.hasWrapedImage = c),
              this.$body.focus(),
              this.selectNode(c.parent()[0]));
        },
        showModal: function (b, c, d) {
          ...
          if (
            (this.$modal.find("span.wbbm-title-text").html(c.title),
            c.tabs && c.tabs.length > 1)
          ) {
            f.addClass("hastabs");
            var g = a('<div class="wbbm-tablist">')
              .appendTo(e)
              .append("<ul>")
              .children("ul");
            a.each(
          ...
          d ? f.find("#wbbm-remove").show() : f.find("#wbbm-remove").hide(),
            a.each(
              c.tabs,
              a.proxy(function (b, c) {
                var e = a("<div>")
                  .addClass("tab-cont tab" + b)
                  .attr("tid", b)
                  .appendTo(h);
                b > 0 && e.hide(),
                  c.html
                    ? e.html(this.strf(c.html, this.options))
                    : a.each(
                        c.input,
                        a.proxy(function (b, c) {
                          (c.value = d[c.param.toLowerCase()]),
                            "seltext" != c.param.toLowerCase() ||
                              (c.value && "" != c.value) ||
                              (c.value = this.getSelectText(
                                this.options.bbmode
                              )),
                            c.value &&
                              0 == c.value.indexOf("<span id='wbbid") &&
                              a(c.value).is("span[id*='wbbid']") &&
                              (c.value = a(c.value).html()),
                            e.append(
                              c.type && "div" == c.type
                                ? this.strf(
            ...
            a.isFunction(c.onLoad) && c.onLoad.call(this, b, c, d),
            f.find("#wbbm-submit").click(
              a.proxy(function () {
                ...
                this.$modal.find(".wbbm-inperr").remove(),
                  ...
                  a.each(
                    ...
                    a.proxy(function (b, d) {
                      var e = a(d).parents(".tab-cont").attr("tid"),
                        ...
                        i = "";
                      i = a(d).is("input,textrea,select")
                        ? a(d).val()
                        : a(d).html();
                      var j = c.tabs[e].input[b].validation;
                      "undefined" != typeof j &&
                        (i.match(new RegExp(j, "i")) ||
                          ((g = !1),
                          a(d)
                            .after(
                              '<span class="wbbm-inperr">' +
                                CURLANG.validation_err +
                                "</span>"
                            )
                  ...
                  g &&
                    (a.log("Last range: " + this.lastRange),
                    this.selectLastRange(),
                    d && this.wbbRemoveCallback(b, !0),
                    this.wbbInsertCallback(b, f),
                    this.closeModal(),
                    this.updateUI());
              }, this)
            ),
            f.find("#wbbm-remove").click(
              a.proxy(function () {
                this.selectLastRange(),
                  this.wbbRemoveCallback(b),
                  this.closeModal(),
                  this.updateUI();
              }, this)
            ),
            ...
            a("body").height() > a(window).height() &&
              a(document.body).css("padding-right", "18px"),
            this.$modal.show(),
            this.isMobile
              ? f.css("margin-top", "10px")
              : f.css(
                  "margin-top",
                  (a(window).height() - f.outerHeight()) / 3 + "px"
                ),
            setTimeout(
              a.proxy(function () {
        ...
        getParams: function (b, c, d) {
          ...
          if (this.options.bbmode) {
            ...
            i &&
              a.each(f, function (a, b) {
                e[b.replace(/\{|\}/g, "").replace(/"/g, "'").toLowerCase()] =
                  i[a + 1];
              });
          } else {
            ...
            this.options.imgupload === !0
              ? (this.$modal.find("#imguploader").dragfileupload({
                  ...
                  success: a.proxy(function (a) {
                    this.$txtArea.insertImage(a.image_link, a.thumb_link),
                      this.closeModal(),
                      this.updateUI();
                  }, this),
                }),
        ...
        debug: function (b) {
          if (this.options.debug === !0) {
            ...
            "undefined" != typeof console
              ? console.log(c - this.startTime + " ms: " + b)
              : a("#exlog").append(
                  "<p>" + (c - this.startTime) + " ms: " + b + "</p>"
                ),
              (this.startTime = c);
          }
        },
        ...
        fixTableTransform: function (b) {
          return b
            ? -1 == a.inArray("table", this.options.buttons)
              ? b.replace(/\<(\/*?(table|tr|td|tbody))[^>]*\>/gi, "")
              : b
                  .replace(
                    /\<(\/*?(table|tr|td))[^>]*\>/gi,
                    "[$1]".toLowerCase()
      ...
      (a.log = function (b) {
        "undefined" != typeof wbbdebug &&
          wbbdebug === !0 &&
          ("undefined" != typeof console
            ? console.log(b)
            : a("#exlog").append("<p>" + b + "</p>"));
      }),
      ...
      (a.fn.wdrag = function (b) {
        ...
        (b.scope.drag_mousedown = function (e) {
          e.preventDefault(),
            ...
            a(document).bind(
              "mousemove",
              a.proxy(b.scope.drag_mousemove, this)
            ),
          ...
          (b.scope.drag_mouseup = function (d) {
            c === !0 &&
              (d.preventDefault(),
              a(document).unbind("mousemove", b.scope.drag_mousemove),
          ...
          (b.scope.drag_mousemove = function (a) {
            ...
            var c = 0,
              e = 0;
            if (
              (b.axisX && (c = a.pageX - d.x),
              b.axisY && (e = a.pageY - d.y),
              0 != e)
            ) {
              var f = d.sheight + e;
              f > d.height &&
                f <= b.scope.options.resize_maxheight &&
                (1 == b.scope.options.bbmode
                  ? b.scope.$txtArea.css(
                      b.scope.options.autoresize === !0
                        ? "min-height"
                        : "height",
                      f + "px"
                    )
          ...
          a(this).bind("mousedown", b.scope.drag_mousedown),
          a(document).bind("mouseup", a.proxy(b.scope.drag_mouseup, this));
      }),
      ...
      (a.fn.bbcode = function (a) {
        return "undefined" != typeof a
          ? (this.data("wbb").options.bbmode
              ? this.data("wbb").$txtArea.val(a)
              : this.data("wbb").$body.html(this.data("wbb").getHTML(a)),
            this)
          : this.data("wbb").getBBCode();
      }),
      (a.fn.htmlcode = function (a) {
        return this.data("wbb").options.onlyBBMode ||
          this.data("wbb").inited !== !0
          ? void 0
          : "undefined" != typeof a
          ? (this.data("wbb").$body.html(a), this)
          : this.data("wbb").getHTML(this.data("wbb").$txtArea.val());
      }),
      ...
      (a.fn.insertImage = function (a, b) {
        var c = this.data("wbb"),
          d = b
            ? c.getCodeByCommand("link", {
                url: a,
                seltext: c.getCodeByCommand("img", { src: b }),
              })
            : c.getCodeByCommand("img", { src: a });
      ...
      (b.prototype = {
        init: function () {
          if (null != window.FormData) {
            ...
            var b = a.proxy(function (a) {
                ...
                this.$loader
                  .children("span")
                  .text(CURLANG.loading + ": " + b + "%");
              }, this),
              c = jQuery.ajaxSettings.xhr();
            c.upload && c.upload.addEventListener("progress", b, !1),
              (this.$block[0].ondrop = a.proxy(function (b) {
                b.preventDefault(), this.$block.removeClass("dragover");
                var d = b.dataTransfer.files[0];
                if (
                  this.opt.validation &&
                  !d.name.match(new RegExp(this.opt.validation))
                )
                  return this.error(CURLANG.validation_err), !1;
                var e = new FormData();
                e.append(this.opt.fileParam, d),
                  this.opt.extraParams &&
                    a.each(this.opt.extraParams, function (a, b) {
                      e.append(a, b);
                    }),
                  (this.$loader = a(
                    '<div class="loader"><img src="' +
                  ...
                  a.ajax({
                    ...
                    success: a.proxy(function (a) {
                      a && 1 == a.status
                        ? this.opt.success(a)
                        : this.error(a.msg || CURLANG.error_onupload);
                    }, this),
        ...
        error: function (a) {
          this.$block
            ...
            .remove()
            .end()
            .append('<span class="upl-error">' + a + "</span>")
            .addClass("wbbm-brdred");
        },
      });
  })(jQuery);
